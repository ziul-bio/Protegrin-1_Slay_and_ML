...
count_matrix <- read.csv(paste(getwd(), "/data/count_matrix.txt", sep=""), header=FALSE, sep = " ")
...
# Dataframe with just the differential expressed peptides. lfg <= -1 and p. ajusted <= 0.05
